            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="https://www.gravatar.com/avatar/{!! md5(access()->user()->email) !!}" class="user-image" alt="User Image"/>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                {!! access()->user()->name !!}
                                <small>{{ trans('strings.backend.general.member_since') }} {!! access()->user()->created_at !!}</small>
                            </p>
                        </li>
                        <!-- Menu Footer-->
