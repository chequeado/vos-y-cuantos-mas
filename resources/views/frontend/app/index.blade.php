...
@section('content')
    <div ng-controller="MainCtrl" ng-init="init('{{$cat}}')" class="row">
        ...
        <p class="text-right" ng-cloak ng-hide="loading || thanks">@{{index+1}} de @{{questions.length}}</p>
        ...
        <div ng-hide="loading" ng-cloak class="col-xs-12">
        	<div ng-show="questionMode && !thanks">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a ng-show="chooseMsg!=null" class="btn btn-lg btn-primary btn-block" ng-click="goToAnswer()">Ver resultado</a>
                    </div>
                </div>
        	</div>
        	<div ng-hide="questionMode || thanks">
                ...
                <div class="row">
                    <div class="col-xs-12">
        	        	<button class="btn btn-primary btn-lg btn-block" ng-hide="index+1 == questions.length" ng-click="next()">Siguiente pregunta</button>
        	        	<button class="btn btn-primary btn-lg btn-block" ng-show="index+1 == questions.length" ng-click="finish()">Finalizar</button>
                    </div>
                </div>
        	</div>
